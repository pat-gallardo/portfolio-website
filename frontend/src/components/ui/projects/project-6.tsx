    ...
    const cards = [
        {
          ...
          thumbnail:
          require('../../../assets/images/fmss-ticket-1.jpg'),
        },
        {
          id: 2,
          content: <SkeletonTwo />,
          ...
          thumbnail:
          require('../../../assets/images/fmss-ticket-2.jpg'),
        },
        {
          id: 3,
          ...
          className: "col-span-1",
          thumbnail:
          require('../../../assets/images/fmss-ticket-3.jpg'),
        },
        {
          id: 4,
          ...
          className: "md:col-span-2",
          thumbnail:
          require('../../../assets/images/fmss-ticket-4.jpg'),
        },
      ];
    return cards
}
